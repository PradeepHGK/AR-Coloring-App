...
public class EventManager : Pixelplacement.Singleton<EventManager>
{
    ...
    public void OnTrackingFoundInvoke(string trackableName, GameObject trackableObject) => OnTrackingFound.Invoke(trackableName, trackableObject);

    public event Action OnTrackingLost;
    public void OnTrackingLostInvoke() => OnTrackingLost.Invoke();

    public event Action DownloadAssetbundle;
    public void DownloadAssetbundleInvoke() => DownloadAssetbundle.Invoke();
